...
- 7cf239e: Document the raised source-video cap on the sound endpoints: `videoToSound` and `videoToVideoSound` accept sources up to 480 seconds (8 minutes), up from 180.
